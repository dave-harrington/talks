...
Revised author guidelines on statistical posted on NEJM website July 2019
...
- All points we discussed have been in the statistical literature for decades

Add consistency to

- Statistical reviewing at NEJM

- Standards of analysis in initial reporting
...
Every good paper should have a path to publication
...
Normal review time and weekly publication schedule make significant changes difficult.
...
Have we made it easier to make unsupported claims?
...
- Choose a method of FWER or FDR control that is most favorable to the analyst    
    ...
    - Minimize the minimum $p$-values or     
...
Overlooked distinction between confirmation and discovery
...
- No easy general recommendation for point estimates and confidence intervals for inteaction effects.
